...
def get_current_weather():
    ...
    # w = mgr.weather_at_place("Kuala Lumpur, MY").to_dict()["weather"]
...
def get_forecast_weathers():
    ...
    # f = mgr.weather_at_place("Kuala Lumpur, MY").forecast.weathers
...
def local_timestamp2local_datetime(timestamp):
    # local_datetime = datetime.fromtimestamp(timestamp, pytz.timezone('Asia/Kuala_Lumpur'))
